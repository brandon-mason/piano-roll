...
function Piano(props) {
    ...
    (0, react_1.useEffect)(() => {
        if (Object.keys(playbackOff).length > 0)
            console.log(playbackOff);
    }, [playbackOff]);
    (0, react_1.useEffect)(() => {
        if (Object.keys(playbackOn).length > 0)
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (props.mode === 'playing' || props.mode === 'recording') { // || (props.midiState.mode === 'recording' && Object.keys(midiRecorded).length > 0) && props.keysPressed) {
            ...
            let pbKu = { ...props.keysPressed, ...props.keysUnpressed };
            let state = [];
            ...
            else if (Object.keys(props.playback).includes(props.pulseNum.toString())) {
