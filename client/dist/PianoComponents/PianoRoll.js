...
function NoteLabels(props) {
    const memoNoteLabels = (0, react_1.useMemo)(() => {
        ...
        for (var x = props.octaveArray.length - 1; x >= 0; x--) {
            for (var y = 11; y >= 0; y--) {
                gridLabelOctaves.push((0, jsx_runtime_1.jsx)(Key, { qwertyKey: qwertyNote[y].key, note: qwertyNote[y].note, altNote: qwertyNote[y].altNote, octave: props.octaveArray[x] }, qwertyNote[y].note + props.octaveArray[x]));
            }
